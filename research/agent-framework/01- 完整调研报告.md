...
| "Agent 等于自动化脚本" | Agent 具备动态决策能力，能根据环境反馈调整策略，而非预定义流程 |
...
| **SuperAGI** | 15k+ | 开源自主 Agent 框架，支持多 Agent 并行 | Python | 2026-01 | [GitHub](https://github.com/TransformerApps/AI-Engine) |
...
| **Reflexion: Language Agents with Verbal Reinforcement Learning** | Shinn et al., MIT | 2023 | NeurIPS 2023 | 自我反思机制提升 Agent 性能 | 被引 3000+ |
| **The Rise and Potential of Large Language Model Based Agents** | Zhang et al., Tsinghua | 2024 | arXiv | 系统性 Agent 技术综述 | 被引 1500+ |
| **AgentBench: Evaluating LLMs as Agents** | Liu et al., Tsinghua | 2024 | arXiv | Agent 能力评估基准 | 被引 1200+ |
| **AutoGen: Enabling Next-Gen LLM Applications via Multi-Agent Conversation** | Microsoft | 2024 | arXiv | 多 Agent 对话框架 | 被引 2500+ |
| **LangGraph: Building Stateful Multi-Agent Applications** | LangChain AI | 2024 | arXiv | 状态图编排机制 | 新兴热门 |
...
| **A Survey on Large Language Model Based Human-Agent Collaboration** | Tsinghua | 2024 | arXiv | 人机协作综述 | 被引 600+ |
| **Large Language Model Based Multi-Agent Systems: A Survey** | CUHK | 2024 | arXiv | 多 Agent 系统综述 | 被引 900+ |
| **Planning with Large Language Models for Code Generation** | Meta AI | 2024 | arXiv | 代码生成中的规划 | 被引 500+ |
| **MemoryBank: Enhancing Memory Utilization in LLM Agents** | PKU | 2025 | arXiv | 记忆增强机制 | 2025 前沿 |
...
| 时间 | 事件 | 发起方 | 影响 |
|------|------|--------|------|
| **2022-11** | ChatGPT 发布，引发 LLM 应用探索 | OpenAI | 奠定 Agent 技术的基座模型基础 |
| **2023-02** | AutoGPT 爆火，自主 Agent 概念兴起 | Significant Gravitas | 展示 LLM 自主执行的潜力 |
| **2023-03** | LangChain 开源，LLM 编排标准化 | LangChain AI | 成为 LLM 应用开发的事实标准 |
| **2023-04** | ReAct 论文发布，推理 + 行动范式确立 | Princeton | 提供 Agent 决策的理论基础 |
| **2023-09** | AutoGen 发布，多 Agent 协作成为主流 | Microsoft | 推动多 Agent 研究方向 |
| **2023-10** | BabyAGI/CrewAI 等轻量框架涌现 | 社区 | 降低 Agent 开发门槛 |
| **2024-01** | LangGraph 发布，状态图编排引入 | LangChain AI | 解决循环和状态管理难题 |
| **2024-03** | Dify/Flowise 等低代码平台兴起 | 创业公司 | 让非技术人员也能构建 Agent |
| **2024-06** | OpenHands 等项目探索代码执行 Agent | All-Hands-AI | Agent 开始具备编程能力 |
| **2025-01** | Andrew Ng 提出 Agentic Workflow 概念 | DeepLearning.AI | 确立"Agentic"为独立技术方向 |
| **2025-06** | 多模态 Agent 成为新热点 | 多家机构 | 视觉 + 语言的跨模态能力 |
| **2026-02** | 当前状态：Agent 框架进入成熟期，企业级应用加速落地 | 行业共识 | 从实验走向生产 |
