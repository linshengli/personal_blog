...
| **Multi Agent vs 群体智能** | 群体智能强调简单个体的涌现行为；Multi Agent 允许复杂Agent 协作 |
...
| **ChatDev: Communicative Agents for Software Development** | PKU | 2024 | arXiv | 多 Agent 软件开发 | 被引 800+ |
| **MetaGPT: Meta Programming for Multi-Agent Collaboration** | MetaGPT | 2024 | arXiv | 元编程多 Agent 框架 | 被引 700+ |
